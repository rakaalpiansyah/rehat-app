                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Kelola rutinitas produktif Anda",
                  ...
                  child: filteredSchedules.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) =>
                              _buildScheduleCard(filteredSchedules[index]),
                        ),
                ),
              ],
            ),
        ...
        children: [
          Expanded(
              child: _StatItem(
                  ...
                  label: "Total",
                  color: ScheduleTheme.primaryPurple)),
          Container(width: 1, height: 30, color: Colors.grey[200]),
          Expanded(
              child: _StatItem(
                  count:
                      allSchedules.where((s) => s.isActive).length.toString(),
                  label: "Aktif",
                  color: ScheduleTheme.accentBlue)),
          Container(width: 1, height: 30, color: Colors.grey[200]),
          Expanded(
              child: _StatItem(
                  count:
  ...
  Widget _buildScheduleCard(ScheduleModel item) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: item.isActive
                ? ScheduleTheme.primaryPurple.withOpacity(0.2)
                : Colors.transparent,
            width: 1.5),
      ),
      child: Column(
        children: [
          Row(
            ...
            children: [
                  ...
                  children: [
                    Text(item.title, // Tambah info delay di judul (opsional)
                        ...
                        style: const TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 16,
                            color: ScheduleTheme.textDark)),
                    const SizedBox(height: 6),
                    Row(children: [
                      const Icon(Icons.access_time_rounded,
                          size: 14, color: ScheduleTheme.textGrey),
                      const SizedBox(width: 4),
                      Text("${item.startTime} - ${item.endTime}",
                          style: const TextStyle(
                              color: ScheduleTheme.textGrey, fontSize: 13))
                    ]),
                  ],
                ),
              ),
              Switch.adaptive(
                  value: item.isActive,
                  activeColor: ScheduleTheme.primaryPurple,
            ...
            child: Wrap(
              ...
              children: item.activeDays
                  .map((day) => Container(
                      ...
                      decoration: BoxDecoration(
                          color: item.isActive
                              ? ScheduleTheme.primaryPurple.withOpacity(0.1)
                              : Colors.grey[100],
                      ...
                      child: Text(day,
                          style: TextStyle(
                              ...
                              color: item.isActive
                                  ? ScheduleTheme.primaryPurple
                                  : ScheduleTheme.textGrey))))
                  .toList(),
            ),
          ),
          Padding(
            ...
            Expanded(
                child: OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(
                        foregroundColor: ScheduleTheme.primaryPurple,
                        side: BorderSide(
                            color:
                                ScheduleTheme.primaryPurple.withOpacity(0.3)),
...
class _StatItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(children: [
        ...
        Text(label,
            style: const TextStyle(fontSize: 12, color: ScheduleTheme.textGrey))
      ]);
}
  ...
  Widget build(BuildContext context) => Column(children: [
        Text(val,
            style: const TextStyle(
                ...
                color: ScheduleTheme.textDark)),
        Text(label,
            style: const TextStyle(fontSize: 11, color: ScheduleTheme.textGrey))
      ]);
}
